...
export default function PayslipsManualUploadPage() {
    ...
    <main className="container wide stack" style={{ margin: 0 }}>
      ...
      <div className="card stack">
        ...
        <div className="payslips-bulk-filters-row payslips-bulk-filters-row-3">
          <input
            list="payslips-manual-departments"
            value={departmentFilter}
            onChange={(e) => setDepartmentFilter(e.target.value)}
            placeholder="Departamento"
          />
          <datalist id="payslips-manual-departments">
            {departments.map((item) => (
              <option key={item} value={item} />
            ))}
          </datalist>
          <input
            list="payslips-manual-positions"
            value={positionFilter}
            onChange={(e) => setPositionFilter(e.target.value)}
            placeholder="Cargo"
          />
          <datalist id="payslips-manual-positions">
            {positions.map((item) => (
              <option key={item} value={item} />
            ))}
          </datalist>
          <input
            list="payslips-manual-contracts"
            value={contractFilter}
            onChange={(e) => setContractFilter(e.target.value)}
            placeholder="Tipo de contrato"
          />
          <datalist id="payslips-manual-contracts">
            {contracts.map((item) => (
              <option key={item} value={item} />
            ))}
          </datalist>
