...
import { tenantCompaniesService } from "../tenant-companies/index.js";
...
const tenantUsersService = new TenantUsersService(tenantUsersRepository, coreAuthTenantService, tenantCompaniesService);
